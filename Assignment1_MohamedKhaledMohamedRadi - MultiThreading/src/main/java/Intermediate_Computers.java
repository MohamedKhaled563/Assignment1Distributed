...
class ClientHandler implements Runnable {
    ...
    public void run() {
        try {
            DataInputStream computersDriverIS = new DataInputStream(s.getInputStream());
            DataOutputStream computersDriverOS = new DataOutputStream(s.getOutputStream());
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                ClientHandler ch = new ClientHandler(driverSocket);
